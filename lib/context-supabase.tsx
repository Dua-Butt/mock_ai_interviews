...
// //         answersProgress: interview.answers_progress,
// //       }));
...
// //         overall_feedback: interview.overall_feedback || null,
// //         strengths: interview.strengths || null,
// //         improvements: interview.improvements || null,
...
// //       answersProgress: data.answers_progress,
// //     };
...
// //     if (updates.overall_feedback) dbUpdates.overall_feedback = updates.overall_feedback;
// //     if (updates.strengths) dbUpdates.strengths = updates.strengths;
// //     if (updates.improvements) dbUpdates.improvements = updates.improvements;
...
// //     }
// //     if (updates.answersProgress !== undefined) {
// //       dbUpdates.answers_progress = updates.answersProgress;
// //     }
...
//       setInterviews(formattedInterviews);
//     } catch (error: any) {
//       // ✅ Silently ignore abort errors — expected during OTP/password reset flows
...
//         interview_type: interview.interviewType,
//         difficulty: interview.difficulty,
//         number_of_questions: (interview as any).numberOfQuestions,
//         questions: interview.questions,
//         status: interview.status,
//         score: interview.score || null,
//         feedback: interview.feedback || null,
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    // ✅ FIX: Directly check session on mount — this handles page refresh
    // onAuthChange alone does NOT reliably fire on refresh in all Supabase versions
    ...
    // ✅ Also keep the listener for login/logout/token refresh events
    const unsubscribe = onAuthChange((user) => {
      setUser(user);
      if (user) {
        loadInterviews(user.id);
      ...
      // Don't set isLoading here — getSession already handled it
    });
