...
// //   // Track isCallActive + callStatus in refs so callbacks always see current values
// //   const isCallActiveRef2 = useRef(false);
// //   const callStatusRef = useRef<string>('idle');
// //   useEffect(() => {
// //     isCallActiveRef2.current = isCallActive;
// //   }, [isCallActive]);
// //   useEffect(() => {
// //     callStatusRef.current = callStatus;
// //   }, [callStatus]);

// //   // SINGLE back button handler — always ends call and saves results
// //   useEffect(() => {
...
// //       if (callActive) {
// //         window.history.pushState(null, '', window.location.href);
// //         console.log('🔙 Back pressed — ending call and saving results...');
...
// //       if (callActive) {
// //         e.preventDefault();
// //         e.returnValue = 'Your interview is in progress. Leaving will save your results.';
// //       }
// //     };
...
// //     };
// //   }, []); // empty deps — uses refs for live values
...
// //     console.log(`🤖 Evaluating ${fullConversation.length} messages with AI...`);
...
// //   // Keep completeRef pointing to latest handleCompleteInterview — no stale closures
...
// //                             <p className="text-xs text-purple-400">AI is evaluating your interview...</p>
// //                           </div>
// //                         )}
// //                       </div>
// //                     )}
...
// //                     <li>Start the call — AI conducts your <strong>{interview.interviewType}</strong> interview</li>
// //                     <li>Speak freely — the full conversation is recorded</li>
// //                     <li>End the call — saved instantly, AI evaluates on the results page</li>
...
//         {/* Main call card */}
//         <div className="rounded-2xl border border-white/[0.06] bg-white/[0.03] backdrop-blur-sm p-8 mb-5">
...
//           {/* Subtitles */}
//           {(callStatus === 'active' || callStatus === 'ended') && (
//             <div className="mt-8 rounded-xl border border-white/5 bg-white/[0.03] px-5 py-4 min-h-[56px] flex items-center justify-center">
//               {subtitles ? (
...
//         {/* Typed answer card */}
//         <div className="rounded-2xl border border-white/[0.06] bg-white/[0.03] backdrop-blur-sm p-6 mb-5">
